...
void DbHelper::up(){
    ...
    this->runSql(sql);
    sql = "CREATE TABLE IF NOT EXISTS AGENDAMENTO (ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,ID_DOADOR INTEGER NOT NULL,ID_RECEPTOR INTEGER NOT NULL,STATUS INTEGER NOT NULL,ID_lOCAL INTEGER NOT NULL,DATA_AGENDADO TEXT NOT NULL,HORARIO_AGENDADO TEXT NOT NULL);";
    this->runSql(sql);
    sql = "CREATE TABLE IF NOT EXISTS AGENDAMENTO_ITENS ( ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ID_AGENDAMENTO INTEGER NOT NULL,ID_RESIDUO INTEGER NOT NULL,QUANTIDADE REAL NOT NULL);";
    this->runSql(sql);
}
